...
cria_campos(){
    ...
    echo "$(date +'%d-%m-%Y %H:%m') : Criado campo da tabela $tabela" >> log/$(echo $tabela)-log
...
cria_tabela(){
    ...
    echo "$(date +'%d-%m-%Y %H:%m') : Le arquivo $arquivo e gera tabela  $tabela" >> log/$(echo $tabela)-log
...
cria_indice(){
    ...
    echo "$(date +'%d-%m-%Y %H:%m') : Gera indice da tabela $tabela" >> log/$(echo $tabela)-log
